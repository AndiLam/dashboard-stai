...
@section('content')
<h1 class="text-4xl font-bold mb-5">Kelola Jadwal Mata Kuliah</h1>

<div class="bg-white shadow-md rounded-lg p-6">
<div class="mb-4 flex justify-between items-center">
        <a href="{{ route('tambahJadwalMk') }}" 
            class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 inline-block text-center">Tambah Jadwal
        </a>
    <div class="relative w-1/3">
        <input type="text" placeholder="Cari jadwal..." class="border border-gray-300 rounded-md px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-green-400"/>
    ...
    <table class="w-full border-collapse border border-gray-300 text-left text-gray-700">
        ...
        <tbody>
            <tr>
                ...
                <td class="border border-gray-300 px-4 py-2">PAI-1</td>
                <td class="border border-gray-300 px-4 py-2">Jumat</td>
                <td class="border border-gray-300 px-4 py-2">07:40-10:10</td>
            ...
            <tr>
                ...
                <td class="border border-gray-300 px-4 py-2">PAI-1</td>
                <td class="border border-gray-300 px-4 py-2">Jumat</td>
                <td class="border border-gray-300 px-4 py-2">13:40-16:10</td>
                <td class="border border-gray-300 px-4 py-2">Sopian Alviana, S.Kom., M.Kom</td>
                <td class="border border-gray-300 px-4 py-2">
                    <button class="bg-blue-500 text-white px-3 py-1 rounded-md hover:bg-blue-600 mr-2">
                        Edit
